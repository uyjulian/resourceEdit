...
CFLAGS += -DRESOURCEEDIT_EXPORTS -D_USRDLL -DMINGW_HAS_SECURE_API -DUNICODE -D_UNICODE -DNO_STRICT -DCMAKE_INTDIR=\"Release\"   
...
SOURCES := ../tp_stub.cpp EditResource.cpp ExeIconData.cpp IconFile.cpp Main.cpp
OBJECTS := $(SOURCES:.c=.o)
OBJECTS := $(OBJECTS:.cpp=.o)
OBJECTS := $(OBJECTS:.asm=.o)
OBJECTS := $(OBJECTS:.rc=.o)

BINARY ?= resourceEdit.dll
ARCHIVE ?= resourceEdit.$(GIT_HASH).7z
